...
//       }
//       return reply.send({ success: true, config: result.rows[0] })
//     } catch (err) {
...
//         `SELECT id, name, status, created_at FROM organizations ORDER BY created_at DESC`
//       )
...
//     const { org_id, action_type, user_input, model } = request.body
